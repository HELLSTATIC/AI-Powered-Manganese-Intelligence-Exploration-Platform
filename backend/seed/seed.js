...
const seedGeologicalRegions = [
  ...
  { name: "Iron Ore Supergroup Manganese Horizon", beltGroup: "Iron Ore Supergroup", states: ["Odisha", "Jharkhand"], lithology: "Shale, Banded Iron Formation, Chert, Manganese Oxide Lenses", manganeseAssociation: "Supergene oxide enrichment along weathered BIF caps", structuralFeature: "Supergene caps & stratiform thrust sheets", latitude: 22.1000, longitude: 85.3000, resourcePotential: "HIGH" },
  { name: "Sandur Schist Belt Manganese Deposit", beltGroup: "Dharwar Craton (Sandur Group)", states: ["Karnataka"], lithology: "Ferruginous Phyllite, Metagreywacke, Manganiferous Slate", manganeseAssociation: "Residual and syngenetic stratiform horizons", structuralFeature: "Synclinal basin folds & shear zones", latitude: 15.1000, longitude: 76.5500, resourcePotential: "MEDIUM" },
  { name: "Eastern Ghats Kodurite Horizon", beltGroup: "Khondalite Belt", states: ["Andhra Pradesh"], lithology: "Kodurite, Manganese Silicates, Charnockite, Garnet-Sillimanite Gneiss", manganeseAssociation: "Hydrothermal & metasomatic manganese silicate enrichment", structuralFeature: "High-grade granulite facies lineaments", latitude: 18.2500, longitude: 83.5000, resourcePotential: "MODERATE" }
];
